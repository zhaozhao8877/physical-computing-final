...
- How do they interact with each other? 
  ...
  Part1: the energy circle with HTML
            ...
            Step3: Press red button on Pikachu (which means Pikachu eat the apple)—
                         HTML(page3) pops up
            Step4: Press the green button (which means you feed Pikachu a pepper)—the yellow 
                         light on Pikachu’s head flashes (which means Pikachu is angry so flashing to 
                         against)--HTML(page4)pops up
